...
(function (window) {
    ...
    var user = {
        "name": "william",
        "subName": "bill",
        "logPic": "image/dongnecomlogo.png",
...
projects.headerfooter = function(){
        // var HTMLheaderName = '<h2 id="name" class="supertitle text-uppercase"><strong>%data%</strong></h2>';
        // var HTMLheaderSubName = '<h3 id="subname" class="supertitle text-uppercase">%data%</h3>';
